## Generated SDC file "digital_recognition.sdc"
...
create_generated_clock -name {dri_clk} -source [get_pins {u_pll|altpll_component|auto_generated|pll1|clk[2]}] -divide_by 400 -master_clock {u_pll|altpll_component|auto_generated|pll1|clk[2]} [get_registers {i2c_dri:u_i2c_dr|dri_clk}] 
